...
with open(path + "tiles.csv","wt") as csv:
    ...
    print("# Units are meters",file=csv)
    ...
    for level in [8, 9, 10, 11, 12]:
        ...
        for i_x in range(n_x):
            ...
            for i_y in range(n_y):
                ...
                z0=np.nanmin(a)
                z1=np.nanmax(a)
                #Write everything in m
                print(f"{level},{i_x},{i_y},{x0:25.15e},{y0:25.15e},{z0:25.15e},{x1:25.15e},{y1:25.15e},{z1:25.15e}",file=csv)
                ...
                with open(incfn,"wt") as incf:
                    ...
                    print(f"#declare x0={x0};",file=incf)
                    print(f"#declare x1={x1};",file=incf)
                    print(f"#declare y0={y0};",file=incf)
                    print(f"#declare y1={y1};",file=incf)
                    print(f"#declare z0={z0};",file=incf)
                    print(f"#declare z1={z1};",file=incf)
